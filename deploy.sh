...
if [ -z "$deploymentName" ]; then
	echo "you will check the deployment status at https://ms.portal.azure.com/#resource/subscriptions/e225d10c-2fce-4a2c-8ab8-fbf0cf28b99e/resourcegroups/CAAPI/eventlogs"
        deploymentName="caapi_nixml"
fi
