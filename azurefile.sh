...
sudo curl https://raw.githubusercontent.com/bartuer/CAAPI_provision/master/dockervolumedriver.service -o /etc/systemd/system/multi-user.target.wants/azurefile-dockervolumedriver.service
sudo ln -s /etc/systemd/system/multi-user.target.wants/azurefile-dockervolumedriver.service  /usr/lib/systemd/system/azurefile-dockervolumedriver.service 
